...
const userAgent = `Mozilla/5.0 (iPhone; CPU iPhone OS 18_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/${major}.0.${patch}.${build} Mobile/15E148 Safari/604.1`
